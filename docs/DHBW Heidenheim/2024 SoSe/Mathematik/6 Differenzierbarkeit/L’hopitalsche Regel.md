Gegeben sei eine Menge D und ein Punkt a ∈ D. Die Funktion f(x) sei auf D \ {a} definiert als f(x) = g(x) / h(x). Die Funktionen g(x) und h(x) seien in der Umgebung des Punktes a differenzierbar.
